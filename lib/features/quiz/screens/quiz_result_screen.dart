...
class _QuizResultScreenState extends State<QuizResultScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final answeredCount =
        widget.userAnswers.where((ans) => ans.isNotEmpty).length;
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.close,
                color: Theme.of(context).colorScheme.onBackground, size: 28),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          _buildStatItem(
                              ...
                              'Đúng',
                              '${widget.correctCount}'),
                          _buildStatItem(Icons.cancel, AppTheme.errorRed, 'Sai',
                              '$wrongCount'),
                          _buildStatItem(
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          _buildStatItem(Icons.star, AppTheme.warningYellow,
                              'XP', '+${widget.xpEarned}'),
                          _buildStatItem(Icons.timer, AppTheme.primaryBlue,
                              'Thời gian', _formatTime(widget.durationSeconds)),
                        ],
                      ),
                    ],
                  ),
                ...
                if (_showReview) ...[
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final userAns = index < widget.userAnswers.length
                          ...
                          children: [
                            ...
                            if (q.type == QuestionType.wordToMeaning)
                              Padding(
                                ...
                                child: Text('/${q.vocabulary.pronunciation}/',
                                    style: TextStyle(
                                        fontSize: 16,
                                        color: Theme.of(context)
                                            .colorScheme
