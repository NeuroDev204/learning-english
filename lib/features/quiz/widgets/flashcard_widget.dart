  ...
  Widget build(BuildContext context) {
    return FlipCard(
      ...
      front: Container(
        ...
        child: Center(
          child: SingleChildScrollView( // Cho phép cuộn nếu chữ quá to
      ...
      back: Container(
        decoration: AppTheme.whiteCardDecoration(),
        child: Center(
          child: SingleChildScrollView( // Quan trọng: Chống lỗi tràn màn hình
            ...
            child: Column(
              ...
              children: [
                Text(
                  vocabulary.meaning,
                  style: const TextStyle(fontSize: 28, color: AppTheme.textDark, height: 1.3),
                  textAlign: TextAlign.center,
                ),
              ],
            ),
