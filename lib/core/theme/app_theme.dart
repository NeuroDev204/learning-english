...
class AppTheme {
  ...
  static const Color warningYellow =
      Color(0xFFFFD93D); // Bright cheerful yellow
  ...
  static ThemeData get darkTheme {
    ...
    const Color darkPrimaryBlue =
        Color(0xFF82C4FF); // Lighter blue for dark mode
    const Color darkBackground = Color(0xFF121212); // Material dark background
    const Color darkSurface = Color(0xFF1E1E1E); // Card background
    const Color darkTextPrimary = Color(0xFFE3E3E3); // Primary text
    const Color darkTextSecondary = Color(0xFFB0B0B0); // Secondary text
    ...
    return ThemeData(
      ...
      appBarTheme: const AppBarTheme(
        ...
        elevation: 0,
        centerTitle: true,
        iconTheme: IconThemeData(color: darkPrimaryBlue),
        titleTextStyle: TextStyle(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          side: const BorderSide(color: darkPrimaryBlue, width: 2.5),
          padding: const EdgeInsets.symmetric(vertical: 18, horizontal: 24),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(20),
          ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: darkPrimaryBlue, width: 2.5),
        ),
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: errorRed, width: 1.5),
        ...
        prefixIconColor: darkPrimaryBlue,
        suffixIconColor: darkPrimaryBlue,
      ),
      ...
      // Icon theme
      iconTheme: const IconThemeData(color: darkPrimaryBlue, size: 24),
